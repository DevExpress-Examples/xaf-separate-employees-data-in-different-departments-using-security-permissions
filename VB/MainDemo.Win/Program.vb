...
Namespace MainDemo.Win
    Public Class Program
        Shared Private Sub winApplication_CustomizeFormattingCulture(ByVal sender As Object, ByVal e As CustomizeFormattingCultureEventArgs)
            e.FormattingCulture = CultureInfo.GetCultureInfo("en-US")
        End Sub

        <STAThread>
        Public Shared Sub Main(ByVal arguments As String())
            Dim winApplication As MainDemoWinApplication = New MainDemoWinApplication()
