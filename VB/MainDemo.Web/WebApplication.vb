...
Namespace MainDemo.Web
    Public Partial Class MainDemoAspNetApplication
        ...
        Private Sub MainDemoAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)
            e.Updater.Update()
            e.Handled = True
        End Sub
        ...
        Private Sub InitializeComponent()
            ...
            AddHandler Me.DatabaseVersionMismatch, New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(AddressOf Me.MainDemoAspNetApplication_DatabaseVersionMismatch)
